...
def fonction(ami,equipment):
     print(f"Salut {ami}, Il faudra changer la configuration de la salle de serveur. J'ai enfin reçu {equipment} que j'ai commandé")
...
fonction("Marc","les Rack nvent Shroff")
...
fonction("Pierre","les commutateurs")
