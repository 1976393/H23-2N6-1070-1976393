...
class App(ctk.CTk):
    ...
    # Voir ÉNONCÉ
    def resumer(self):
        self.txt_resume.delete(0.0, tk.END)
        textr = self.creer_resume()
        self.txt_resume.insert(0.0,textr)
